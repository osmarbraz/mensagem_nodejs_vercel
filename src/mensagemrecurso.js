/**
 * Métodos de acesso aos recursos de Mensagem
 */
...
/**
 * Modifica a mensagem através dos dados da requisição recebidos como parâmetro de corpo do tipo JSON.
 * 
 * @param {*} request 
 * @param {*} response 
 */    
...
/**
 * Modifica a mensagem através de dados da requisição recebidos como parâmetro de consulta na URL.
 * 
 * @param {*} request 
 * @param {*} response 
 */    
...
/**
 * Modifica a mensagem através de dados da requisição recebidos como parâmetro de path na URL.
 * 
 * @param {*} request 
 * @param {*} response 
 */    
